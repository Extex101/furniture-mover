...
function love.load()
   ...
   local loungeDef = {
      ...
      {w=17, h=57, n="Religious bookshelf", col={r=112, g=66, b=69}}, -- 58+4
      {w=17, h=58, n="New Pat", col={r=240, g=167, b=122}}, -- 58+4
      {w=38, h=87, n="Girl Lounge", col={r=222, g=73, b=35}},
      -- {w=38, h=87, n="Imaginary Lounge", col={r=0,g=0,b=0}},
      {w=38, h=88, n="Boy lounge", col={r=230, g=246, b=247}},
      ...
      {w=15, h=17, n="Wire rack light", col={r=150, g=150, b=150}},
   }
   list = {}
   mouse = HC.point(0,0)
   ...
   presets = {
     ...
     {x = 401, y = 432, r=0},
     {x = 509, y = 425, r = 0},
     {x = 626.39, y = 239.20, r = -0.31415926535898},
     {x = 386, y = 340, r = -0.15707963267949},
     {x = 537, y = 424.91783110475, r = 0.078539816339745},
     {x = 431, y = 338, r = 1.4922565104552},
     {x = 389, y = 267, r = 1.5707963267949},
     {x = 349.5, y = 364.5, r = 0},
     {x = 453.9, y = 425, r = 1.5707963267949},
     {x = 499, y = 362, r = 3.1415926535898},
     {x = 419, y = 385, r = 3.1415926535898},
     {x = 597, y = 325, r = 0.31415926535898},
     {x = 612.8, y = 188.38, r = -1.8849555921539},
     {x = 622, y = 385, r = 0.31415926535898},
   }
